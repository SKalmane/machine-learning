...
class LearningAgent(Agent):
    ...
    def get_actionWithMaxQValue(self, state):
        """ The get_actionWithMaxQValue function is called when the agent is 
        asked to find the actions with the max Q Values. """
        ########### 
        ## TO DO ##
        ###########
        # Calculate the maximum Q-value of all actions for a given state
